...
static NSString * const ZSSRichTextEditorToolbarDashList = @"com.zedsaid.toolbaritem.dashList";
...
static NSString * const ZSSRichTextEditorToolbarChecklist = @"com.zedsaid.toolbaritem.checklist";
static NSString * const ZSSRichTextEditorToolbarFormat = @"com.zedsaid.toolbaritem.format";
static NSString * const ZSSRichTextEditorToolbarDismiss = @"com.zedsaid.toolbaritem.dismiss";
